...
export default async function Page({ params }: Props) {
  ...
  return (
    <main className="container mx-auto mt-10 flex max-w-6xl flex-col gap-10 md:flex-row">
      ...
      <aside className="top-28 h-full space-y-12 text-white md:sticky md:w-[40%]">
        <div className="space-y-6 rounded-lg bg-neutral-900 p-6">
          <h1 className="text-2xl font-extrabold">{campaignSingle.title}</h1>
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="ml-auto block rounded-lg border-2 border-transparent bg-green-500 px-8 py-3 font-bold text-black duration-300 hover:border-green-500 hover:bg-transparent hover:text-white">
                Donate Now
              </div>
            </div>
          </div>
